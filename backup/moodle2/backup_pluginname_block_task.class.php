...
require_once($CFG->dirroot.'//blocks/pluginname/backup/moodle2/backup_pluginname_stepslib.php');
require_once($CFG->dirroot.'//blocks/pluginname/backup/moodle2/backup_pluginname_settingslib.php');

/**
 * Provides all the settings and steps to perform a complete backup of block_pluginname.
 */
class backup_pluginname_block_task extends backup_block_task {
