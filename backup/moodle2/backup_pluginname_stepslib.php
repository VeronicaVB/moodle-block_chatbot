...
/**
 * Backup steps for block_pluginname are defined here.
 *
 ...
 */
class backup_pluginname_block_structure_step extends backup_block_structure_step {
    ...
    protected function define_structure() {
        ...
        $attributes = null;
        $finalelements = null;
        $root = new backup_nested_element('block_pluginname', $attributes, $finalelements);
