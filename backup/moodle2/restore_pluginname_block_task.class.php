...
/**
 * The task that provides a complete restore of block_pluginname is defined here.
 *
...
require_once($CFG->dirroot.'//blocks/pluginname/backup/moodle2/restore_pluginname_stepslib.php');

/**
 * Restore task for block_pluginname.
 */
class restore_pluginname_block_task extends restore_block_task {
